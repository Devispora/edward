...
def five_minute_creation_cooldown(sheet_creation_date: str):
...
def has_been_two_days(request_time: datetime) -> bool:
...
def is_due_to_release(request_time: datetime) -> bool:
